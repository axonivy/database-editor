...
const workspaceName = 'database-editor-test-project';
const user = 'Developer';

const requestHeaders = {
  'X-Requested-By': 'role-editor-tests',
...
const isScreenshotRun = () => {
  ...
  return process.argv.includes('--project=screenshots') || process.argv[projectIndex + 1] === 'screenshots';
};
